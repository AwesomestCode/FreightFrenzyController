...
@Autonomous(name = "Noble Autonomous", group = "Concept")

public class NobleAutonomous extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        robot.moveDistance(new HardwareRobot.DistanceVector(2, , 0, 1));
